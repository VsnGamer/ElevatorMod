...
public class BlockElevatorLime extends Block implements ITileEntityProvider{

	public BlockElevatorLime() {
		super(Material.CLOTH);
		setUnlocalizedName(Ref.EBlocks.ELEVATOR_LIME.getUnlocalizedName());
		setRegistryName(Ref.EBlocks.ELEVATOR_LIME.getRegistryName());
		setHardness(0.8F);

...
public class BlockElevatorGray extends Block implements ITileEntityProvider{

	public BlockElevatorGray() {
		super(Material.CLOTH);
		setUnlocalizedName(Ref.EBlocks.ELEVATOR_GRAY.getUnlocalizedName());
		setRegistryName(Ref.EBlocks.ELEVATOR_GRAY.getRegistryName());
		setHardness(0.8F);

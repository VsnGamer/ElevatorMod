...
public class BlockElevatorPink extends Block implements ITileEntityProvider{

	public BlockElevatorPink() {
		super(Material.CLOTH);
		setUnlocalizedName(Ref.EBlocks.ELEVATOR_PINK.getUnlocalizedName());
		setRegistryName(Ref.EBlocks.ELEVATOR_PINK.getRegistryName());
		setHardness(0.8F);

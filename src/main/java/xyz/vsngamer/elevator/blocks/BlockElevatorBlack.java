...
public class BlockElevatorBlack extends Block implements ITileEntityProvider{

	public BlockElevatorBlack() {
		super(Material.cloth);
		setUnlocalizedName(Ref.EBlocks.ELEVATOR_BLACK.getUnlocalizedName());
		setRegistryName(Ref.EBlocks.ELEVATOR_BLACK.getRegistryName());
		setHardness(0.8F);

...
public class BlockElevatorCyan extends Block implements ITileEntityProvider{

	public BlockElevatorCyan() {
		super(Material.CLOTH);
		setUnlocalizedName(Ref.EBlocks.ELEVATOR_CYAN.getUnlocalizedName());
		setRegistryName(Ref.EBlocks.ELEVATOR_CYAN.getRegistryName());
		setHardness(0.8F);

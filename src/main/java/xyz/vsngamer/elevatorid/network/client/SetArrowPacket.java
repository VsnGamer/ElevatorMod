...
public record SetArrowPacket(boolean value, BlockPos pos) implements CustomPacketPayload {
    public static final ResourceLocation ID = new ResourceLocation(ElevatorMod.ID, "set_arrow");

    public SetArrowPacket(final FriendlyByteBuf buf) {
    ...
    public static class Handler {
        ...
        public void handle(SetArrowPacket msg, PlayPayloadContext ctx) {
